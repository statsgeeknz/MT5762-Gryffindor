...
data$number <- factor(data$number, levels = c(0, 1, 2, 3, 4, 5, 6, 7, 8), 
                      labels = c("never", "1-4", "5-9", "10-14", "15-19", "20-29", "30-39", "40-60", "60+"))
...
correlations <- cor(dataFiltered, na.rm = TRUE)
